...
public interface FulfillmentItemCommandService {
    Optional<FulfillmentItem> handle(MarkFulfillmentItemAsShippedCommand command);
    Optional<FulfillmentItem> handle(MarkFulfillmentItemAsReceivedCommand command);
    Optional<FulfillmentItem> handle(CancelFulfillmentItemCommand command);
}
