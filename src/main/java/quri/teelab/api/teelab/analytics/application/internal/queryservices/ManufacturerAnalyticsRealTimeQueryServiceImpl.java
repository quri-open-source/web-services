...
@Service
public class ManufacturerAnalyticsRealTimeQueryServiceImpl {
    
    private final FulfillmentRepository fulfillmentRepository;
    private final ManufacturerRepository manufacturerRepository;

    public ManufacturerAnalyticsRealTimeQueryServiceImpl(FulfillmentRepository fulfillmentRepository, 
    ...
    public Optional<ManufacturerAnalyticsResource> handle(GetManufacturerAnalyticsByManufacturerIdQuery query) {
        ...
        return Optional.of(new ManufacturerAnalyticsResource(
                manufacturer.get().getId().toString(),
                totalOrdersReceived,
                pendingFulfillments,
                producedProjects,
